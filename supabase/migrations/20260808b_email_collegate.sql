-- Email di conferma collegate a una tappa. Applicato l'08/08/2026.
-- L'utente cerca nella propria Gmail con il token OAuth della sessione
-- (mai salvato qui) e sceglie quali email agganciare: qui restano solo i
-- puntatori (id messaggio, oggetto, mittente), mai il contenuto della mail.
...
create table public.email_collegate (
  ...
  primary key (user_id, poi_id, message_id)
);
